...
class Haet_Sender_Plugin_WP_Support_Plus extends Haet_Sender_Plugin {
	public function __construct( $mail ) {
		$advanced_settings = get_option( 'wpsp_advanced_settings' );
		$ticket_subject   = '[' . __( $advanced_settings['ticket_label_alice'][1], 'wp-support-plus-responsive-ticket-system' ) . ' ' . $advanced_settings['wpsp_ticket_id_prefix'];
