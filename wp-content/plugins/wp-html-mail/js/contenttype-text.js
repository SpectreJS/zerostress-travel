...
* ***********************************/
haet_mailbuilder.create_content_text = function( $contentelement, element_id, content_array ){
    var $ = jQuery;
    for( var name in content_array ){
        mb_text.apply_content( $contentelement.find('[name="' + name + '"]'), content_array[name] );
    }
}
...
* ***********************************/
mb_text.apply_content = function( $element, content ){
    var $ = jQuery;
